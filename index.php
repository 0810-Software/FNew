...
<TITLE>FNew, the 'everyone-can-write-and-read'-social media site.</TITLE>
</HEAD>
...
<input type="hidden" name="sitesearch" value="/"></form></div><hr>
<!-- Start of custom menu links -->
<a href="/write/">write...</a>
<a href="/write/signup/">register</a>
<a href="/posts/">read</a>
<a href="/links/">more...</a>
...
<!-- Start of body content -->
	...
	<h2>Join FNew now!</h2>
You can <a href="/write/signup/">register</a> on FNew and have FNew free for the rest of your life, <b>share: anything. feel: safe.</b> on FNew no harmfull or sexual content is allowed. And every post you make, you need to verify.<br></br>
	We even have apps, <a href="/desktop-apps/">download them now</a>!
<h2>About FNew</h2>
FNew is a expirimental social media site with an 'everyone-can-write-and-read'-policy by 0810 Software.
	<h3>The design and idea of FNew</h3>
<p>Marnix 0810, starter of 0810 Software is a open-source-orientated hobby programmer, with the desire to make this world and your life better.</p>
<p>He conceived the basic idea of FNew when he was thirteen and has tried to build it ever since, now here we are!</p>

<h2>About 0810 Software</h2>
<p>0810 Software is a Software and Web developing organization focused on Open-source products, 0810 Software was started by <a href="/account/marnix0810.html" target="_blank">@Marnix0810</a> on Github.<br></br>0810 Software stands for an open web and software for everyone, software that makes your life better, we spend our free time in these ideals. And we hope it isn’t all for nothing.<br></br>You can find us at <a href="https://software0810.wordpress.com" target="_blank">https://software0810.wordpress.com</a>.</p>
<!-- End of body content -->
<!-- Start of bottombar -->
