# FNew Standards ver. 20.4.10.1 document
...
<DIV id="titlebar" bgcolor="#EFE4B0"><font color="purple">
    <hr>
	<div style="text-align:right" id="Menubutton"><span style="font-size:30px;cursor:pointer" onclick="openNav()">&#8595; menu</span></div>
    <h1><font color="#851b2d">F</font><font color="#590076">N</font><font color="#6b9000">ew</font>  by <img src="https://software0810.files.wordpress.com/2019/11/cropped-0810software-2.png?w=60" alt="0810 Software"></h1>
    <hr>
    </font></div>
...
<div id="myNav" class="overlay">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <div class="overlay-content">
<DIV id="titleoverlay" bgcolor="#EFE4B0"><font color="purple"><h1><font color="#851b2d">F</font><font color="#590076">N</font><font color="#6b9000">ew</font>  by <img src="https://software0810.files.wordpress.com/2019/11/cropped-0810software-2.png?w=60" alt="0810 Software"></h1></font></div>
...
- The results from <https://web.dev> tests have been used to optimize some of the code in the standards.
- The FNew color schemes have been updated to a more 0810 Software-ish look.
